class NoSyncAcc implements Runnable {
    ...
    private void makeTransfer(int amt) {
        ...
        if (acct.showBalance() >= amt) {
            ...
            System.out.println(Thread.currentThread().getName() + " drawn completed");

        } else {

            System.out.println("Not enough money in account for " + Thread.currentThread().getName() + " to drawn " + acct.showBalance());
